 ...
 * @version 0.0.1
 */
public class RouteRevert2 {

  private static final String ROUTE_QUEUE_NAME = "route_queue_name2";
  ...
  public static void main(String[] args) throws Exception {
    ...
    // 多个类型可直接添加
    channel.queueBind(ROUTE_QUEUE_NAME, RouteSender.EXCHANGE_ROUTE_NAME, "key3");
    ...
    DefaultConsumer consumer =
        new DefaultConsumer(channel) {
          ...
          public void handleDelivery(
              ...
              throws IOException {
            System.out.println("当前路由模式2收到的消息:" + new String(body));
