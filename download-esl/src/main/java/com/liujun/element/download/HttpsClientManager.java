...
import com.liujun.element.constant.HttpDefConnCfg;
...
public class HttpsClientManager {
  ...
  private static final String[] SSL_VERSION = new String[] {"TLSv1.2"};
  ...
  static {
    ...
    Registry<ConnectionSocketFactory> socketFactoryRegistry =
        RegistryBuilder.<ConnectionSocketFactory>create()
            .register(HttpVersionEnum.HTTP.getVersion(), PlainConnectionSocketFactory.INSTANCE)
            .register(HttpVersionEnum.HTTPS.getVersion(), socketFactory)
            .build();
