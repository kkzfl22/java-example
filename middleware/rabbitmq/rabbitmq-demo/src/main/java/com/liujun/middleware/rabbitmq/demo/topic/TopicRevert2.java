 ...
 * @version 0.0.1
 */
public class TopicRevert2 {

  private static final String TOPIC_REVERT_NAME = "topic_revert_queue_name2";
  ...
  public static void main(String[] args) throws Exception {
    ...
    channel.queueBind(TOPIC_REVERT_NAME, TopicSender.TOPIC_EXCHANGE_NAME, "vs.#");
